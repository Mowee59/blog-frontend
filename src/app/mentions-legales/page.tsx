...
const MentionsLegales = () => {
  return (
    <main className="mx-auto max-w-4xl px-4 py-8">
      <h2 className="mb-4 mt-8 text-2xl font-bold">Définitions</h2>
      <p className="mb-4">
      ...
      <p className="mb-4">
        <strong>Propriétaire</strong> : Aniss Mahfoudi 59800 Lille
        <br />
        <strong>Responsable publication</strong> : Aniss – contact@aniss.dev
        <br />
        Le responsable publication est une personne physique ou une personne
        morale.
        <br />
        <strong>Webmaster</strong> : Aniss – contact@aniss.dev
        <br />
        <strong>Hébergeur</strong> : gandi – 63-65 Boulevard Masséna 75013 Paris
        01 70 37 76 61
        <br />
        <strong>Délégué à la protection des données</strong> : Aniss –
        contact@aniss.dev
        <br />
      </p>
      ...
      <p className="mb-4">
        ...
        responsable du traitement des Données Personnelles est : Aniss Mahfoudi.{" "}
        <a
          href="https://blog.aniss.dev"
          className="text-blue-600 hover:text-blue-800"
        >
        ...
        est représenté par Aniss, son représentant légal
      </p>
      ...
      <ul className="mb-4 list-disc space-y-2 pl-6">
        <li>Aucune donnée n'est collectée ni traitée</li>
      </ul>
      ...
      <address className="mb-4 mt-4 not-italic">
        Aniss Mahfoudi – DPO, Aniss <br />
        59800 Lille.
      </address>
      ...
      <h3 className="mb-3 mt-6 text-xl font-semibold">Sécurité</h3>
      ...
      <h3 className="mb-3 mt-6 text-xl font-semibold">9.1. « COOKIES »</h3>
